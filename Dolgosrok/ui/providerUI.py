...
class providerUIWidget(object):
    def setupUi(self, Widget):
        ...
        self.providerTBV = QTableView(Widget)
        self.providerTBV.setObjectName(u"providerTBV")
        self.providerTBV.horizontalHeader().setStretchLastSection(False)
        self.providerTBV.verticalHeader().setVisible(True)

        self.verticalLayout.addWidget(self.providerTBV)
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle(QCoreApplication.translate("Widget", u"\u041f\u043e\u0441\u043c\u043e\u0442\u0440\u0435\u0442\u044c \u0438\u043d\u0444\u043e\u0440\u043c\u0430\u0446\u0438\u044e \u043e \u043f\u0440\u043e\u0432\u0430\u0439\u0434\u0435\u0440\u0435", None))
