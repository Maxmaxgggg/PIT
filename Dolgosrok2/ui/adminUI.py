#
#
#           ФАЙЛ СОДЕРЖИТ UI ВИДЖЕТА АДМИНА
#
#
...
class adminUIWidget(object):
    def setupUi(self, Widget):
        ...
        self.editOwnersPBN = QPushButton(Widget)
        self.editOwnersPBN.setObjectName(u"infoPBN")
        self.editOwnersPBN.setText('Редактировать собственников')
        self.verticalLayout.addWidget(self.editOwnersPBN)
    ...
    def retranslateUi(self, Widget):
        Widget.setWindowTitle('Поиск собственника (админ)')
